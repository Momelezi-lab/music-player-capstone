    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-purple-950 to-slate-900 text-white font-sans">
      ...
      <div className="container mx-auto px-4 py-8 pb-32">
        ...
        <header className="text-center mb-12">
          <div className="flex items-center justify-center gap-4 mb-4">
            <div className="p-4 bg-gradient-to-br from-fuchsia-500 to-cyan-500 rounded-2xl shadow-lg shadow-fuchsia-500/30">
              <FaMusic className="text-4xl" />
            </div>
          </div>
          <h1 className="text-5xl md:text-7xl font-black tracking-tight bg-gradient-to-r from-fuchsia-400 via-pink-400 to-cyan-400 bg-clip-text text-transparent">
            Vibe Player
          </h1>
        ...
        <div className="max-w-2xl mx-auto mb-12">
          <div className="flex gap-3 bg-white/5 backdrop-blur-xl p-2 rounded-2xl border border-white/10 shadow-2xl">
            ...
            <button
              onClick={searchMusic}
              className="bg-gradient-to-r from-fuchsia-600 to-pink-600 hover:from-fuchsia-500 hover:to-pink-500 px-8 py-4 rounded-xl font-bold text-lg shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-fuchsia-500/25"
            >
              Search
            </button>
          </div>
              ...
              {favorites.map((track) => (
                <div
                  ...
                  className={`flex-shrink-0 w-40 cursor-pointer group ${
                    currentTrack?.id === track.id ? "ring-2 ring-fuchsia-500 rounded-xl" : ""
                  }`}
                >
                  ...
                  <p className="mt-2 text-sm font-medium truncate">{track.title}</p>
        ...
        {tracks.length > 0 && (
          <section>
            <h2 className="text-2xl font-bold mb-6 text-slate-300">Search Results</h2>
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-5">
              {tracks.map((track) => (
                <div
                  key={track.id}
                  className={`group relative bg-white/5 backdrop-blur-sm rounded-2xl overflow-hidden transition-all duration-300 hover:bg-white/10 hover:shadow-xl hover:shadow-fuchsia-500/10 ${
                ...
                >
                  ...
                  >
                    ...
                    <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                      <div className="w-14 h-14 bg-fuchsia-500 rounded-full flex items-center justify-center shadow-lg transform scale-75 group-hover:scale-100 transition-transform">
                    ...
                    {currentTrack?.id === track.id && isPlaying && (
                      <div className="absolute bottom-2 left-2 flex gap-1">
                        <div className="w-1 h-4 bg-fuchsia-500 rounded animate-pulse"></div>
                        <div className="w-1 h-4 bg-fuchsia-500 rounded animate-pulse" style={{ animationDelay: "150ms" }}></div>
                        <div className="w-1 h-4 bg-fuchsia-500 rounded animate-pulse" style={{ animationDelay: "300ms" }}></div>
                      </div>
                    )}
                  </div>
                    ...
                    <div className="flex justify-between items-start gap-2">
                      ...
                      >
                        {isFavorite(track.id) ? (
                          ...
                          <FaRegHeart className="text-slate-400 hover:text-pink-500 text-lg transition-colors" />
                        )}
                      </button>
                    </div>
                  </div>
        ...
        {!loading && tracks.length === 0 && !query && (
          <div className="text-center py-20">
            <FaMusic className="text-6xl text-slate-700 mx-auto mb-6" />
      ...
      {currentTrack && (
        <div className="fixed bottom-0 left-0 right-0 bg-slate-900/95 backdrop-blur-xl border-t border-white/10 shadow-2xl">
          ...
          >
            <div
              className="h-full bg-gradient-to-r from-fuchsia-500 to-pink-500 relative"
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-4 flex-1 min-w-0">
                ...
                >
                  {isFavorite(currentTrack.id) ? (
                    ...
                    <FaRegHeart className="text-slate-400 hover:text-pink-500 text-xl transition-colors" />
                  )}
                </button>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <button
                  ...
                  className="w-14 h-14 bg-gradient-to-r from-fuchsia-500 to-pink-500 rounded-full flex items-center justify-center shadow-lg shadow-fuchsia-500/30 hover:scale-105 transition-transform"
                >
                  {isPlaying ? (
